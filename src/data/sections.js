...
export const SECTIONS = {
  // =========================
  // 📚 ÉTAGÈRE CENTRALE — PROJETS WEB (BD)
  // =========================
  projects: {
    title: "Projets",
    description:
...
Ce séjour constitue aujourd’hui une étape importante de mon parcours, illustrant ma capacité à m’engager pleinement dans un environnement difficile et à en tirer des enseignements durables.`,
    ...
    rows: [
      {
        ...
        items: [
          {
            name: "React",
            desc: "Hooks, components, routing.",
            logo: "/logos/react.png",
            href: "https://react.dev/",
          },
          {
            name: "Vite",
            desc: "Build tool rapide.",
            logo: "/logos/vite.png",
  ...
  // =========================
  // 📦 ÉTAGÈRE GAUCHE — CARRIÈRE LOGISTIQUE
  // =========================
  career: {
    ...
    items: [
      ...
      },
      {
        ...
        bullets: [
          "Gestion de stock + équipe opérationnelle",
          "Amélioration tracking via codes-barres",
        ],
      },
      {
        ...
        bullets: [
          "Gestion stock + dépotage conteneurs",
          "Contact parties prenantes + management",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "Contribution Lean Manufacturing (Falcon 900/2000)",
          "Création de base de données / Kanbans",
        ],
      },
    ],
  },
